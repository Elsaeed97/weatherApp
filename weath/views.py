...
#  My APi key : C547CA32-8ADB-4C95-90AC-BAF074A3AB1A
...
def index(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=C547CA32-8ADB-4C95-90AC-BAF074A3AB1A")
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=C547CA32-8ADB-4C95-90AC-BAF074A3AB1A")
